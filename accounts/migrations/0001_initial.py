    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='default_user_photo.png', upload_to='user_photos')),
                ('mobile', models.CharField(default=1234567890, max_length=10)),
                ('gender', models.CharField(default='Male', max_length=50)),
                ('dilevery_address', models.TextField(blank=True)),
                ('pincode', models.CharField(default=123456, max_length=6)),
